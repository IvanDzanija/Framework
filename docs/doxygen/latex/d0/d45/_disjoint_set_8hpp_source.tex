...
\DoxyCodeLine{00033\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classmaf_1_1_disjoint_set}{DisjointSet}}\ \{}
...
\DoxyCodeLine{00057\ \ \ \ \ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_ab4ed86e30e1e52168532ec22fef32f5b}{add\_set}}(\textcolor{keyword}{const}\ T\ \&x)\ \{}
...
\DoxyCodeLine{00063\ \ \ \ \ \}}
\DoxyCodeLine{00064\ }
\DoxyCodeLine{00071\ \ \ \ \ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_a5694edb1c1503df39a79b77f0370f727}{add\_set}}(T\ \&\&x)\ \{}
...
\DoxyCodeLine{00077\ \ \ \ \ \}}
\DoxyCodeLine{00078\ }
\DoxyCodeLine{00090\ \ \ \ \ [[nodiscard]]\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_a8ba4ca7bf154318426dbafbbe294c6ba}{find}}(\textcolor{keywordtype}{size\_t}\ a)\ \{}
...
\DoxyCodeLine{00107\ \ \ \ \ \}}
\DoxyCodeLine{00108\ }
\DoxyCodeLine{00119\ \ \ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_ae8731c4fd9d0b6f8bed4f0b035306b9f}{unite}}(\textcolor{keywordtype}{size\_t}\ a,\ \textcolor{keywordtype}{size\_t}\ b)\ \{}
\DoxyCodeLine{00120\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{size\_t}\ repr\_a\ =\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_a8ba4ca7bf154318426dbafbbe294c6ba}{find}}(a);}
\DoxyCodeLine{00121\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{size\_t}\ repr\_b\ =\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_a8ba4ca7bf154318426dbafbbe294c6ba}{find}}(b);}
\DoxyCodeLine{00122\ }
...
\DoxyCodeLine{00134\ \ \ \ \ \}}
\DoxyCodeLine{00135\ }
\DoxyCodeLine{00144\ \ \ \ \ [[nodiscard]]\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_acb80ae42f825cae6c0f7e9f71eedf689}{united}}(\textcolor{keywordtype}{size\_t}\ a,\ \textcolor{keywordtype}{size\_t}\ b)\ \{\ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_a8ba4ca7bf154318426dbafbbe294c6ba}{find}}(a)\ ==\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_a8ba4ca7bf154318426dbafbbe294c6ba}{find}}(b);\ \}}
\DoxyCodeLine{00145\ }
\DoxyCodeLine{00152\ \ \ \ \ [[nodiscard]]\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_ab00d6b60b33f011bf1097f7dbb5ed27b}{count\_sets}}()\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00160\ \ \ \ \ \}}
\DoxyCodeLine{00161\ }
\DoxyCodeLine{00168\ \ \ \ \ [[nodiscard]]\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_a91da1bee9be42396620df397876b0354}{set\_size}}(\textcolor{keywordtype}{size\_t}\ x)\ \{}
\DoxyCodeLine{00169\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{size\_t}\ repr\_x\ =\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_a8ba4ca7bf154318426dbafbbe294c6ba}{find}}(x);}
\DoxyCodeLine{00170\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \_sizes.at(repr\_x);}
\DoxyCodeLine{00171\ \ \ \ \ \}}
\DoxyCodeLine{00172\ }
\DoxyCodeLine{00179\ \ \ \ \ [[nodiscard]]\ T\ \&\mbox{\hyperlink{classmaf_1_1_disjoint_set_ab53433226000f309b61a554731df3f08}{get}}(\textcolor{keywordtype}{size\_t}\ handle)\ \{}
\DoxyCodeLine{00180\ \ \ \ \ \ \ \ \ \_validate\_handle(handle);}
\DoxyCodeLine{00181\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \_objects.at(handle);}
\DoxyCodeLine{00182\ \ \ \ \ \}}
\DoxyCodeLine{00183\ }
\DoxyCodeLine{00190\ \ \ \ \ [[nodiscard]]\ \textcolor{keyword}{const}\ T\ \&\mbox{\hyperlink{classmaf_1_1_disjoint_set_a29dc5cc12f53da7cd23add20b9e95e59}{get}}(\textcolor{keywordtype}{size\_t}\ handle)\textcolor{keyword}{\ const\ }\{}
\DoxyCodeLine{00191\ \ \ \ \ \ \ \ \ \_validate\_handle(handle);}
\DoxyCodeLine{00192\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ \_objects.at(handle);}
\DoxyCodeLine{00193\ \ \ \ \ \}}
\DoxyCodeLine{00194\ }
\DoxyCodeLine{00203\ \ \ \ \ [[nodiscard]]\ T\ \&\mbox{\hyperlink{classmaf_1_1_disjoint_set_a8193429818a02ccf0ace57e5c7a2faa2}{get\_representative}}(\textcolor{keywordtype}{size\_t}\ handle)\ \{}
\DoxyCodeLine{00204\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{size\_t}\ repr\_handle\ =\ \mbox{\hyperlink{classmaf_1_1_disjoint_set_a8ba4ca7bf154318426dbafbbe294c6ba}{find}}(handle);}
